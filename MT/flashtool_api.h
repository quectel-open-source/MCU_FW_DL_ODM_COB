...
//typedef int (__stdcall *CALLBACK_SETUP_PROGRESS_COLOR)(void *usr_arg, unsigned int color, char *hint);  (remove after BROM DLL v5.1128.03.00)
    ...
    typedef int (__stdcall *CALLBACK_READBACK_CONN_PROGRESS_INIT)(unsigned int rb_addr, unsigned int rb_length, void *usr_arg);
    ...
    typedef int (__stdcall *CALLBACK_FORMAT_CONN_PROGRESS_INIT)(unsigned int begin_addr, unsigned int length, void *usr_arg);
...
typedef int (__stdcall *CALLBACK_PRE_FORMAT_PROGRESS)(unsigned char finished_percentage, void *usr_arg);
    ...
    typedef	struct {
        ...
        // to enable connectivity module advanced mode
        _BOOL                                   m_enable_conn_module_advanced_mode;
    ...
    typedef	struct {
        ...
        // Connectivity module image downloading
        ...
        // Connectivity module da image downloading
        CALLBACK_WRITE_BUF_PROGRESS_INIT    m_cb_download_conn_da_init;
        void *                              m_cb_download_conn_da_init_arg;
        CALLBACK_WRITE_BUF_PROGRESS         m_cb_download_conn_da;
    ...
    typedef	struct {
        ...
        // readback connectivity module progress callback
        CALLBACK_READBACK_CONN_PROGRESS_INIT    m_cb_readback_conn_flash_init;
        void *                                  m_cb_readback_conn_flash_init_arg;
        CALLBACK_READBACK_PROGRESS              m_cb_readback_conn_flash;
        void *                                  m_cb_readback_conn_flash_arg;
...
#define USER_DATA_AREA_NUM              1
    ...
    typedef	struct
    {
        ...
        // connectivity module format progress callback
        CALLBACK_FORMAT_CONN_PROGRESS_INIT  m_cb_format_conn_report_init;
        void *								m_cb_format_conn_report_init_arg;
        CALLBACK_FORMAT_PROGRESS			m_cb_format_conn_report;
        void *								m_cb_format_conn_report_arg;
