...
typedef struct DRAMSetting_v08
{
    DRAMType ramType;
    unsigned int DRAMC_ACTIM0;
    unsigned int DRAMC_ACTIM1;
    unsigned int DRAMC_AC_DERATING;
    unsigned int DRAMC_AC_TIME_05T;
    unsigned int DRAMC_ADDRODLY;
    unsigned int DRAMC_CLKODLY;
    unsigned int DRAMC_CONF1;
    unsigned int DRAMC_CONF2;
    unsigned int DRAMC_DDR2CTL;
    unsigned int DRAMC_DQODLY;
    unsigned int DRAMC_DQSODLY;
    unsigned int DRAMC_DRVCTL1;
    unsigned int DRAMC_GDDR3CTL1;
    unsigned int DRAMC_IODRV8;
    unsigned int DRAMC_LPDDR2_3;
    unsigned int DRAMC_MISCTL0;
    unsigned int DRAMC_MISC;
    unsigned int DRAMC_MRR_CTL;
    unsigned int DRAMC_PADCTL4;
    unsigned int DRAMC_PD_CTRL;
    unsigned int DRAMC_PERFCTL0;
    unsigned int DRAMC_RKCFG;
    unsigned int DRAMC_RRRATE_CTL;
    unsigned int DRAMC_TEST2_3;
    unsigned int DRAMC_TEST2_4;
    unsigned int DRAM_MR1;
    unsigned int DRAM_MR2;
    unsigned int DRAM_MR3;
    unsigned int MEMPLL234_BC;
    unsigned int MEMPLL234_BP;
    unsigned int MEMPLL234_BR;
    unsigned int MEMPLL234_FBDIV;
    unsigned int MEMPLL234_IC;
    unsigned int MEMPLL234_IR;
    unsigned int MEMPLL_DIV;
    unsigned int MEMPLL_SDM_PCW;
    unsigned int EMI_CONA;
    unsigned int EMI_TESTD;
} DRAMSetting_v08;    //for TK6291
...
typedef struct ExternalRAMSetting
{
    ...
    union
    {
        ...
        DRAMSetting_v08 v08[MAX_NUM_EXTERNAL_RAM_SETTING_ENTRIES];
    } u;
...
typedef struct ExternalMemorySetting
{
    ...
    FlashInfo_MTK           flashInfo;  // Required for Combo MCP
