...
typedef enum {
    ...
    ,S_UNSUPPORTED_VER_OF_BOOT_ROM_DLL = 1040   /*!<(1040) <B>[Tool Issue]</B> An error occurs when BROM DLL is illegal. Please check BROM DLL is the correct version.*/
    ...
    ,S_BROM_FAIL_TO_GET_BBCHIP_TINY_SYSTEM_INFO = 2049  /*!<(2049) */
    ,S_BROM_FAIL_TO_GET_BBCHIP_GPS_VERSION_INFO = 2050  /*!<(2050) */
    ,S_BROM_GPS_ONLY_CHIP_IS_NOT_SUPPORTED = 2051  /*!<(2051) */
...
// MT6276 SV5 Bootloader
    ...
    ,S_DA_GPS_DOWNLOAD_FAIL = 3236 /*!<(3236) Failed to download connectivity module(GPS)*/
    ,S_DA_NOR_MAIN_REGION_OVERLAP_BOOT_REGION  = 3237  /*!<(3237) */
    ,S_DA_GPS_FORMAT_FAIL = 3238 /*!<(3238) Failed to format connectivity module(GPS)*/
    ,S_DA_GPS_READBACK_FAIL = 3239 /*!<(3239) Failed to readback connectivity module(GPS)*/
    ,S_DA_ENTER_GPS_RELAY_MODE_FAIL = 3240 /*!<(3240) DA Failed to enter gps relay mode*/
    ,S_DA_OPEN_GPS_DA_FAIL = 3241 /*!<(3241) Failed to open GPS DA*/
    ,S_DA_ERROR_END // END
